...
export default function EarnPage() {
  const vaults = [
    { name: "USDC Flexible", apy: "5.2%", balance: "0.00" },
    { name: "XLM Staking", apy: "4.8%", balance: "0.00" },
  ];
          ...
          >
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-slate-400 text-sm mt-1">Provide liquidity and earn rewards</p>
              </div>
            ...
            <button className="w-full mt-4 bg-slate-800 text-white font-bold uppercase tracking-widest py-3 rounded-xl hover:bg-slate-700 transition-colors">
              Deposit
            </button>
          </motion.div>
        ))}
